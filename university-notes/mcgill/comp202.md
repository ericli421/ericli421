...
This course uses the Python programming language, a high level general purpose programming language. However, the concepts gone over this course are applicable to all programming languages (Java, C, etc.)
